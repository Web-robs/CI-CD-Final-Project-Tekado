...
const socialLinks = [
  { icon: <GitHubIcon />, label: 'GitHub', href: 'https://github.com/Web-robs' },
  { icon: <LinkedInIcon />, label: 'LinkedIn', href: 'https://www.linkedin.com/in/robinyaghi/' },
  { icon: <LanguageIcon />, label: 'Portfolio', href: 'http://robinyaghi.info/' },
...
function Footer() {
  ...
  return (
    <Box component="footer" sx={{ background: 'linear-gradient(135deg, #21070f 0%, #8f0723 55%, #bf092f 100%)', color: 'white', mt: 8 }}>
      <Container maxWidth="xl" sx={{ py: { xs: 6, md: 8 } }}>
        ...
        <Stack direction={{ xs: 'column', md: 'row' }} spacing={2} justifyContent="space-between" alignItems={{ xs: 'flex-start', md: 'center' }}>
          <Typography variant="body2" sx={{ color: 'rgba(226,232,240,0.7)' }}>
            © {new Date().getFullYear()} Tekado. Lebanon & powered worldwide.
          </Typography>
