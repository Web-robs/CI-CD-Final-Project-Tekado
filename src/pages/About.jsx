...
const milestones = [
  {
    year: '2018',
    title: 'Launch',
    description: 'Started Tekado with a mission to curate gear that empowers creators and everyday innovators.',
  },
  {
    year: '2020',
  ...
  return (
    <Container maxWidth="lg" sx={{ pb: 10 }}>
      <Stack spacing={3} sx={{ textAlign: 'center', mt: 6, mb: 6 }} alignItems="center">
        <Chip label="About Tekado" color="primary" variant="outlined" sx={{ alignSelf: 'center' }} />
        ...
        <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 680, mx: 'auto', lineHeight: 1.9, textAlign: 'center' }}>
          Tekado is a collective of engineers, industrial designers, and experience strategists. We scout the highest performing gadgets,
