...
const termsSections = [
  {
    ...
    copy: 'Tekado delivers a curated digital storefront for premium consumer technology. By visiting our site you agree to engage respectfully, refrain from malicious activity, and only submit accurate personal details. Accounts may be suspended when suspicious behaviour is detected to keep the community safe.',
    ...
    <Container maxWidth="md" sx={{ py: { xs: 6, md: 10 } }}>
      <Stack spacing={3} alignItems="center" textAlign="center" sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 680 }}>
          These terms ensure every Tekado order is handled with integrity, transparency, and the level of care you expect from a premium retailer.
        </Typography>
