...
const faqs = [
  {
    ...
    answer: 'Orders placed before 2 PM local warehouse time ship the same day. Lebanon orders arrive in 2 business days, international orders within 4-7 days.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Most of our gear includes a 1-year manufacturer warranty. For Tekado-branded collections we extend that to 24 months automatically.',
  },
  {
          ...
          <Paper elevation={0} sx={{ p: 4, borderRadius: 4, height: '100%' }}>
            <Stack spacing={2}>
              ...
              <Typography variant="body2" color="text.secondary">
                Call +961 (76) 163-826 from 7 AM – 11 PM PST, 7 days a week. We’ll resolve most issues on the spot.
              </Typography>
            </Stack>
          </Paper>
        </Grid>
        <Grid item xs={12} md={4} id="shipping">
          <Paper elevation={0} sx={{ p: 4, borderRadius: 4, height: '100%' }}>
            <Stack spacing={2}>
              ...
              <Typography variant="body2" color="text.secondary">
                Track your order in real time from the Orders dashboard. Text updates available in Lebanon, EU, and APAC regions.
              </Typography>
            </Stack>
          </Paper>
        </Grid>
