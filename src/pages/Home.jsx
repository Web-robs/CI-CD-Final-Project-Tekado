...
const valueProps = [
  {
    ...
    description: 'Complimentary express shipping on all orders over $75 within Lebanon.',
...
const testimonials = [
  {
    ...
    quote: 'Tekado curates gear I didn’t even know I needed. The quality and delivery speed are unmatched.',
  },
  {
    name: 'Morgan Patel',
    ...
    <Box sx={{ my: { xs: 2, md: 4 } }}>
      <Paper
        ...
        sx={{
          ...
          mb: 5,
          position: 'relative',
          background: 'linear-gradient(120deg, rgba(191,9,47,0.95) 0%, rgba(118,3,29,0.9) 100%)',
      ...
      >
        <Grid container sx={{ height: '100%' }} alignItems="stretch">
          ...
          >
            <Chip label="Summer Tech Edit" sx={{ alignSelf: 'flex-start', bgcolor: 'rgba(255,255,255,0.18)', color: 'white', fontWeight: 700 }} />
            <Box>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
              <Button
                ...
                to="/shop"
                sx={{ bgcolor: '#BF092F', '&:hover': { bgcolor: '#a30828' } }}
              >
                Shop best sellers
              </Button>
              <Button
                  ...
                  <Box key={item.title} sx={{ height: '100%', position: 'relative' }}>
                    ...
                    <Box
                      sx={{
                        ...
                        background: 'linear-gradient(180deg, rgba(15,4,8,0.05) 0%, rgba(15,4,8,0.75) 100%)',
                        color: '#fff',
                        p: { xs: 2, md: 3 },
                        borderRadius: '8px',
                      }}
      ...
      <Container maxWidth="xl">
        ...
        <Box sx={{ mt: 10 }}>
          ...
          <Typography variant="body1" color="text.secondary" textAlign="center" sx={{ mb: 4 }}>
            Real stories from customers building their dream setups with Tekado.
          </Typography>
          <Grid container spacing={3}>
